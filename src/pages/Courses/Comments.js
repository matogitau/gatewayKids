...
const Comments = (props) => {
  ...
  return (
    <div>
      <Prompt when={formBeingfilled} message={(location) =>'Are you sure you want to leave? All your entered data will be lost!'}/> 
      ...
      <textarea htmlFor="comment" type="textarea" rows= "4"cols="32" placeholder='Enter Your Comments'onChange={commentHandler}></textarea>
     <Button onClick={finishFocusHandler} type="submit">Send</Button>     
      </form>
    </Card>
    </div>
  );
